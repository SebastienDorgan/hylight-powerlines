...
from hylight_powerlines.llm.image import ensure_dir, read_image
from hylight_powerlines.llm.models import Box, PipelineConfig, PipelineResult, PreAnalysis, Proposal
from hylight_powerlines.llm.steps import (
    SupportsGdino,
    SupportsSam2,
    refine_with_gdino,
    refine_with_sam2,
)
from hylight_powerlines.llm.vis import draw_boxes, save_masks
from hylight_powerlines.llm.vlm import pre_analyze
...
def run_pipeline(
    ...
    *,
    ...
    if gdino_factory is None:
        from .gdino import GroundingDinoHF
